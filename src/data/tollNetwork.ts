...
export const OPERATORS: Record<Operator, OperatorInfo> = {
  EXAT: {
    ...
    official_source_url: 'https://www.exat.co.th/%e0%b8%ad%e0%b8%b1%e0%b8%95%e0%b8%a3%e0%b8%b2%e0%b8%84%e0%b9%88%e0%b8%b2%e0%b8%9c%e0%b9%88%e0%b8%b2%e0%b8%99%e0%b8%97%e0%b8%b2%e0%b8%87/',
    official_doc_name: 'ประกาศอัตราค่าผ่านทางทางการ กทพ. (EXAT Tariff Schedule)',
  },
  BEM: {
    code: 'BEM',
    ...
    official_source_url: 'https://expressway.bemplc.co.th/Rate?id=1',
  ...
  DMT: {
    ...
    official_source_url: 'https://www.tollway.co.th/th/our-services/toll-rates',
    official_doc_name: 'ประกาศอัตราค่าผ่านทางทางการ โทลล์เวย์ (DMT Official Toll Rates)',
  },
  DOH: {
    code: 'DOH',
    ...
    official_source_url: 'https://www.motorway.go.th/',
...
export interface ExpresswayLineInfo {
  name: string;
  short_name: string;
  operator: Operator;
  color: string;
...
export const EXPRESSWAY_LINES: Record<string, ExpresswayLineInfo> = {
  'ทางพิเศษเฉลิมมหานคร': {
    name: 'ทางพิเศษเฉลิมมหานคร (ทางด่วนขั้นที่ 1)',
    short_name: 'เฉลิมมหานคร',
    operator: 'EXAT',
    color: '#0284C7', // Sky Blue 600
    description: 'สายทางด่วนสายแรกของประเทศไทย (สายดินแดง, บางนา, ดาวคะนอง)',
  },
  'ทางพิเศษฉลองรัช': {
    name: 'ทางพิเศษฉลองรัช (รามอินทรา-อาจณรงค์ / วงแหวนรอบนอก)',
    short_name: 'ฉลองรัช',
    operator: 'EXAT',
    color: '#06B6D4', // Cyan 500
    description: 'เส้นทางเชื่อมทางทิศเหนือ รามอินทรา ถึง วงแหวนรอบนอก',
  },
  'ทางพิเศษบูรพาวิถี': {
    name: 'ทางพิเศษบูรพาวิถี (ยกระดับบางนา-ชลบุรี)',
    short_name: 'บูรพาวิถี',
    operator: 'EXAT',
    color: '#1D4ED8', // Royal Blue 700
    description: 'ทางด่วนยกระดับสายยาว กรุงเทพฯ (บางนา) ถึง ชลบุรี',
  },
  'ทางพิเศษกาญจนาภิเษก': {
    name: 'ทางพิเศษกาญจนาภิเษก (บางพลี-สุขสวัสดิ์)',
    short_name: 'กาญจนาภิเษก (EXAT)',
    operator: 'EXAT',
    color: '#3B82F6', // Blue 500
    description: 'ทางพิเศษสายบางพลี-สุขสวัสดิ์ วงแหวนรอบนอกด้านใต้',
  },
  'ทางพิเศษสาย S1': {
    name: 'ทางพิเศษสาย S1 (อาจณรงค์-บางนา)',
    short_name: 'สาย S1',
    operator: 'EXAT',
    color: '#0891B2', // Dark Cyan 600
    description: 'ทางเชื่อมระดับสูง อาจณรงค์ ↔ บูรพาวิถี บางนา',
  },
  'ทางพิเศษศรีรัช': {
    ...
    description: 'ทางด่วนโครงข่ายรอบเมืองกรุงเทพฯ (ส่วน A, B, C, D)',
  },
  'ทางพิเศษประจิมรัถยา': {
    name: 'ทางพิเศษประจิมรัถยา (ศรีรัช-วงแหวนรอบนอก)',
    short_name: 'ประจิมรัถยา',
    operator: 'BEM',
    color: '#6366F1', // Indigo 500
    description: 'ทางด่วนสายตะวันตก หมอชิต 2 ➔ ตลิ่งชัน / ศาลายา',
  },
  'ทางพิเศษอุดรรัถยา': {
    name: 'ทางพิเศษอุดรรัถยา (แจ้งวัฒนะ-บางปะอิน)',
    short_name: 'อุดรรัถยา',
    operator: 'BEM',
    color: '#8B5CF6', // Purple 500
    description: 'ทางด่วนสายบางปะอิน แจ้งวัฒนะ ถึง เชียงราก / ธรรมศาสตร์',
  },
  'ทางหลวงพิเศษหมายเลข 7': {
    name: 'ทางหลวงพิเศษหมายเลข 7 (มอเตอร์เวย์กรุงเทพฯ-ชลบุรี-พัทยา-มาบตาพุด)',
    short_name: 'มอเตอร์เวย์ M7',
    operator: 'DOH',
    color: '#F59E0B', // Amber 500
    description: 'สายหลักกรุงเทพฯ สุวรรณภูมิ ชลบุรี พัทยา ถึง อู่ตะเภา / มาบตาพุด',
  },
  'ทางหลวงพิเศษหมายเลข 9': {
    name: 'ทางหลวงพิเศษหมายเลข 9 (มอเตอร์เวย์วงแหวนรอบนอก)',
    short_name: 'มอเตอร์เวย์ M9',
    operator: 'DOH',
    color: '#D97706', // Dark Amber 600
    description: 'วงแหวนกาญจนาภิเษกรอบนอก (บางปะอิน-ทับช้าง-บางพลี & บางขุนเทียน)',
  },
  'ทางหลวงพิเศษหมายเลข 6': {
    name: 'ทางหลวงพิเศษหมายเลข 6 (มอเตอร์เวย์บางปะอิน-นครราชสีมา)',
    short_name: 'มอเตอร์เวย์ M6 (ฟรี)',
    operator: 'DOH',
    color: '#10B981', // Emerald Green 500 (Free Trial)
    description: 'มอเตอร์เวย์สายอีสาน บางปะอิน สระบุรี ปากช่อง ถึง นครราชสีมา',
  },
  'ทางหลวงพิเศษหมายเลข 81': {
    name: 'ทางหลวงพิเศษหมายเลข 81 (มอเตอร์เวย์บางใหญ่-กาญจนบุรี)',
    short_name: 'มอเตอร์เวย์ M81 (ฟรี)',
    operator: 'DOH',
    color: '#EAB308', // Yellow 500
    description: 'มอเตอร์เวย์สายตะวันตก บางใหญ่ นครปฐม ถึง กาญจนบุรี',
  },
  'ทางยกระดับอุตราภิมุข': {
    name: 'ทางยกระดับอุตราภิมุข (ดอนเมืองโทลล์เวย์ - ช่วงสัมปทาน DMT)',
    short_name: 'ดอนเมืองโทลล์เวย์ (DMT)',
    operator: 'DMT',
    color: '#DC2626', // Red 600
    description: 'ทางยกระดับวิภาวดีรังสิต ช่วงดินแดง ถึง อนุสรณ์สถาน',
  },
  'ทางยกระดับอุตราภิมุข (ส่วนต่อขยาย)': {
    name: 'ทางยกระดับอุตราภิมุข (ช่วงส่วนต่อขยาย DOH อนุสรณ์สถาน-โรงกษาปณ์ ฟรี)',
    short_name: 'โทลล์เวย์ DOH (ฟรี)',
    operator: 'DOH',
    color: '#F97316', // Orange 500
    description: 'ทางยกระดับช่วงอนุสรณ์สถาน ถึง โรงกษาปณ์ / รังสิต (กรมทางหลวง ไม่เก็บค่าผ่านทาง 0 บาท)',
  },
};

export function getLineColor(expresswayLine: string, operator: Operator): string {
  if (EXPRESSWAY_LINES[expresswayLine]) {
    return EXPRESSWAY_LINES[expresswayLine].color;
  }
  for (const [lineKey, lineInfo] of Object.entries(EXPRESSWAY_LINES)) {
    if (expresswayLine.includes(lineKey) || lineKey.includes(expresswayLine)) {
      return lineInfo.color;
    }
  }
  return OPERATORS[operator]?.color || '#3B82F6';
}
...
export const TOLL_PLAZAS: TollPlaza[] = [
  // --- 1. DOH Motorway M9 Eastern & Southern Ring Plazas ---
  {
    ...
    expressway_line: 'ทางหลวงพิเศษหมายเลข 9',
    section: 'วงแหวนตะวันออก (บางปะอิน-บางพลี)',
    operator: 'DOH',
  ...
  },
  {
    ...
    expressway_line: 'ทางหลวงพิเศษหมายเลข 9',
    section: 'ช่วงพระประแดง-บางขุนเทียน',
    operator: 'DOH',
  ...
  // --- 2. DOH Motorway M7 Official Toll Plazas (1–12) ---
  {
    ...
    expressway_line: 'ทางหลวงพิเศษหมายเลข 7',
    section: 'ช่วงกรุงเทพฯ-ชลบุรี-พัทยา-มาบตาพุด',
    operator: 'DOH',
  ...
  // --- 3. DOH Motorway M81 (Bang Yai - Kanchanaburi) ---
  {
    ...
    expressway_line: 'ทางหลวงพิเศษหมายเลข 81',
    section: 'ช่วงบางใหญ่-กาญจนบุรี (ทดลองวิ่งฟรี)',
    operator: 'DOH',
  ...
  // --- 3.5 DOH Motorway M6 (Bang Pa-in - Nakhon Ratchasima / Korat - Free Trial 0 THB) ---
  {
    id: 'doh-m6-bang-pa-in',
    name_th: 'ด่านบางปะอิน (M6 กม. 0+000) (ทดลองวิ่งฟรี 0 บาท)',
    name_en: 'Bang Pa-in Toll Plaza (Motorway M6 - Free Trial)',
    expressway_line: 'ทางหลวงพิเศษหมายเลข 6',
    section: 'ช่วงบางปะอิน-นครราชสีมา (ทดลองวิ่งฟรี)',
    operator: 'DOH',
    coords: [14.1750, 100.6120],
    is_entry: true,
    is_exit: true,
    payment_methods: ['M_PASS', 'EASY_PASS', 'M_FLOW', 'CASH'],
    entry_rates: { class_1: 0, class_2: 0, class_3: 0 },
  },
  {
    id: 'doh-m6-wang-noi',
    name_th: 'ด่านวังน้อย (M6) (ทดลองวิ่งฟรี 0 บาท)',
    name_en: 'Wang Noi Toll Plaza (Motorway M6 - Free Trial)',
    expressway_line: 'ทางหลวงพิเศษหมายเลข 6',
    section: 'ช่วงบางปะอิน-นครราชสีมา (ทดลองวิ่งฟรี)',
    operator: 'DOH',
    coords: [14.2380, 100.7180],
    is_entry: true,
    is_exit: true,
    payment_methods: ['M_PASS', 'EASY_PASS', 'M_FLOW', 'CASH'],
    entry_rates: { class_1: 0, class_2: 0, class_3: 0 },
  ...
  {
    id: 'doh-m6-hin-kong',
    name_th: 'ด่านหินกอง (M6) (ทดลองวิ่งฟรี 0 บาท)',
    name_en: 'Hin Kong Toll Plaza (Motorway M6 - Free Trial)',
    expressway_line: 'ทางหลวงพิเศษหมายเลข 6',
    section: 'ช่วงบางปะอิน-นครราชสีมา (ทดลองวิ่งฟรี)',
    operator: 'DOH',
    coords: [14.3950, 100.8920],
    is_entry: true,
    is_exit: true,
    payment_methods: ['M_PASS', 'EASY_PASS', 'M_FLOW', 'CASH'],
    entry_rates: { class_1: 0, class_2: 0, class_3: 0 },
  ...
  {
    id: 'doh-m6-saraburi',
    name_th: 'ด่านสระบุรี (M6) (ทดลองวิ่งฟรี 0 บาท)',
    name_en: 'Saraburi Toll Plaza (Motorway M6 - Free Trial)',
    expressway_line: 'ทางหลวงพิเศษหมายเลข 6',
    section: 'ช่วงบางปะอิน-นครราชสีมา (ทดลองวิ่งฟรี)',
    operator: 'DOH',
    coords: [14.5120, 100.9580],
    is_entry: true,
    is_exit: true,
    payment_methods: ['M_PASS', 'EASY_PASS', 'M_FLOW', 'CASH'],
    entry_rates: { class_1: 0, class_2: 0, class_3: 0 },
  ...
  {
    id: 'doh-m6-kaeng-khoi',
    name_th: 'ด่านแก่งคอย (M6) (ทดลองวิ่งฟรี 0 บาท)',
    name_en: 'Kaeng Khoi Toll Plaza (Motorway M6 - Free Trial)',
    expressway_line: 'ทางหลวงพิเศษหมายเลข 6',
    section: 'ช่วงบางปะอิน-นครราชสีมา (ทดลองวิ่งฟรี)',
    operator: 'DOH',
    coords: [14.5820, 101.0750],
    is_entry: true,
    is_exit: true,
    payment_methods: ['M_PASS', 'EASY_PASS', 'M_FLOW', 'CASH'],
    entry_rates: { class_1: 0, class_2: 0, class_3: 0 },
  ...
  {
    id: 'doh-m6-muak-lek',
    name_th: 'ด่านมวกเหล็ก (M6) (ทดลองวิ่งฟรี 0 บาท)',
    name_en: 'Muak Lek Toll Plaza (Motorway M6 - Free Trial)',
    expressway_line: 'ทางหลวงพิเศษหมายเลข 6',
    section: 'ช่วงบางปะอิน-นครราชสีมา (ทดลองวิ่งฟรี)',
    operator: 'DOH',
    coords: [14.6340, 101.1980],
    is_entry: true,
    is_exit: true,
    payment_methods: ['M_PASS', 'EASY_PASS', 'M_FLOW', 'CASH'],
    entry_rates: { class_1: 0, class_2: 0, class_3: 0 },
  ...
  {
    id: 'doh-m6-pak-chong',
    name_th: 'ด่านปากช่อง (M6) (ทดลองวิ่งฟรี 0 บาท)',
    name_en: 'Pak Chong Toll Plaza (Motorway M6 - Free Trial)',
    expressway_line: 'ทางหลวงพิเศษหมายเลข 6',
    section: 'ช่วงบางปะอิน-นครราชสีมา (ทดลองวิ่งฟรี)',
    operator: 'DOH',
    coords: [14.6750, 101.4250],
    is_entry: true,
    is_exit: true,
    payment_methods: ['M_PASS', 'EASY_PASS', 'M_FLOW', 'CASH'],
    entry_rates: { class_1: 0, class_2: 0, class_3: 0 },
  ...
  {
    id: 'doh-m6-sikhio',
    name_th: 'ด่านสีคิ้ว (M6) (ทดลองวิ่งฟรี 0 บาท)',
    name_en: 'Sikhio Toll Plaza (Motorway M6 - Free Trial)',
    expressway_line: 'ทางหลวงพิเศษหมายเลข 6',
    section: 'ช่วงบางปะอิน-นครราชสีมา (ทดลองวิ่งฟรี)',
    operator: 'DOH',
    coords: [14.8620, 101.7120],
    is_entry: true,
    is_exit: true,
    payment_methods: ['M_PASS', 'EASY_PASS', 'M_FLOW', 'CASH'],
    entry_rates: { class_1: 0, class_2: 0, class_3: 0 },
  ...
  {
    id: 'doh-m6-kham-thale-so',
    name_th: 'ด่านขามทะเลสอ / นครราชสีมา (M6) (ทดลองวิ่งฟรี 0 บาท)',
    name_en: 'Kham Thale So Toll Plaza (Motorway M6 - Free Trial)',
    expressway_line: 'ทางหลวงพิเศษหมายเลข 6',
    section: 'ช่วงบางปะอิน-นครราชสีมา (ทดลองวิ่งฟรี)',
    operator: 'DOH',
    coords: [14.9600, 101.9450],
    is_entry: true,
    is_exit: true,
    payment_methods: ['M_PASS', 'EASY_PASS', 'M_FLOW', 'CASH'],
    entry_rates: { class_1: 0, class_2: 0, class_3: 0 },
  ...
  },
  {
    ...
    expressway_line: 'ทางพิเศษเฉลิมมหานคร',
    section: 'สายหลักทางพิเศษขั้นที่ 1',
    operator: 'EXAT',
  ...
  // --- 5. EXAT - Chalong Rat (Ram Indra - At Narong - Chatu Chot) ---
  {
    ...
    section: 'ช่วงรามอินทรา-วงแหวนรอบนอก',
    operator: 'EXAT',
  ...
  },
  {
    ...
    expressway_line: 'ทางพิเศษฉลองรัช',
    section: 'ช่วงรามอินทรา-อาจณรงค์',
    operator: 'EXAT',
  ...
  // --- 6. EXAT - Burapha Withi (Bang Na - Chon Buri) ---
  {
    ...
    section: 'ช่วงยกระดับบางนา-ชลบุรี',
    operator: 'EXAT',
  ...
  // --- 7. EXAT - Kanchanaphisek (Bang Phli - Suk Sawat) ---
  {
    ...
    expressway_line: 'ทางพิเศษกาญจนาภิเษก',
    section: 'ช่วงบางพลี-สุขสวัสดิ์',
    operator: 'EXAT',
  ...
  },
  {
    ...
    expressway_line: 'ทางพิเศษศรีรัช',
    section: 'โครงข่ายในเมือง (ส่วน C)',
    operator: 'BEM',
  ...
  },
  {
    ...
    expressway_line: 'ทางพิเศษศรีรัช',
    section: 'โครงข่ายในเมือง (ส่วน D)',
    operator: 'BEM',
  ...
  // --- 9. BEM - Prachim Ratthaya (Si Rat - Outer Ring Road / Chatuchak to Salaya area) ---
  {
    ...
    expressway_line: 'ทางพิเศษประจิมรัถยา',
    section: 'ช่วงศรีรัช-วงแหวนรอบนอก',
    operator: 'BEM',
  ...
  // --- 10. BEM - Udon Ratthaya (Chaeng Watthana - Bang Pa-in) ---
  {
    ...
    expressway_line: 'ทางพิเศษอุดรรัถยา',
    section: 'ช่วงแจ้งวัฒนะ-บางปะอิน',
    operator: 'BEM',
  ...
  },
  {
    ...
    section: 'ช่วงสัมปทาน DMT (ดินแดง-อนุสรณ์สถาน)',
    operator: 'DMT',
  ...
  {
    id: 'doh-dmt-ext-anusorn',
    name_th: 'ด่านอนุสรณ์สถาน (ส่วนต่อขยาย DOH)',
    name_en: 'Anusorn Sam-sahan Plaza (DOH Extension)',
    expressway_line: 'ทางยกระดับอุตราภิมุข (ส่วนต่อขยาย)',
    section: 'ช่วงส่วนต่อขยาย DOH (อนุสรณ์สถาน-โรงกษาปณ์) (ฟรี 0 บาท)',
    operator: 'DOH',
    coords: [13.9550, 100.6185],
    is_entry: true,
    is_exit: true,
    payment_methods: ['M_FLOW', 'CASH'],
    entry_rates: { class_1: 0, class_2: 0, class_3: 0 },
  },
  {
    id: 'doh-dmt-ext-rong-kasap',
    name_th: 'ด่านโรงกษาปณ์ / รังสิต (ส่วนต่อขยาย DOH)',
    name_en: 'Rong Kasap / Rangsit Terminal (DOH Extension)',
    expressway_line: 'ทางยกระดับอุตราภิมุข (ส่วนต่อขยาย)',
    section: 'ช่วงส่วนต่อขยาย DOH (อนุสรณ์สถาน-โรงกษาปณ์) (ฟรี 0 บาท)',
    operator: 'DOH',
    coords: [13.9985, 100.6135],
    is_entry: true,
    is_exit: true,
    payment_methods: ['M_FLOW', 'CASH'],
    entry_rates: { class_1: 0, class_2: 0, class_3: 0 },
...
function generateAllPairwiseEdges(): TollEdge[] {
  ...
  // 8. DMT Tollway Sequential Line (Split into Urban & Northern concession sections)
  const dmtUrbanOrdered = [
    'dmt-din-daeng', 'dmt-sutthisan', 'dmt-lad-prao', 'dmt-ratchada', 'dmt-lak-si'
  ];
  const dmtNorthernOrdered = [
    'dmt-don-mueang', 'dmt-anusorn-sit'
  ];

  addSequentialChain(dmtUrbanOrdered, 'ทางยกระดับอุตราภิมุข (ช่วงดินแดง-ดอนเมือง)', () => [90, 120, 120], ['EMV', 'CASH']);
  addSequentialChain(dmtNorthernOrdered, 'ทางยกระดับอุตราภิมุข (ช่วงดอนเมือง-อนุสรณ์สถาน)', () => [40, 50, 50], ['EMV', 'CASH']);

  // Connection between Urban section (dmt-lak-si) and Northern section (dmt-don-mueang)
  addE('edge-dmt-urban-to-north', 'dmt-lak-si', 'dmt-don-mueang', 'ทางยกระดับอุตราภิมุข (ช่วงดอนเมือง-อนุสรณ์สถาน)', 2.6, 40, 50, 50, ['EMV', 'CASH']);
  addE('edge-dmt-north-to-urban', 'dmt-don-mueang', 'dmt-lak-si', 'ทางยกระดับอุตราภิมุข (ช่วงดินแดง-ดอนเมือง)', 2.6, 90, 120, 120, ['EMV', 'CASH']);
  ...
  // 8.6 DOH Don Mueang Tollway Northern Extension (Anusorn Sam-sahan ↔ Rong Kasap / Rangsit - Free 0 THB)
  addE('edge-doh-dmt-ext-1', 'doh-dmt-ext-anusorn', 'doh-dmt-ext-rong-kasap', 'ทางยกระดับอุตราภิมุข (ส่วนต่อขยาย DOH อนุสรณ์สถาน-โรงกษาปณ์)', 7.1, 0, 0, 0, ['M_FLOW', 'CASH']);
  addE('edge-doh-dmt-ext-2', 'doh-dmt-ext-rong-kasap', 'doh-dmt-ext-anusorn', 'ทางยกระดับอุตราภิมุข (ส่วนต่อขยาย DOH โรงกษาปณ์-อนุสรณ์สถาน)', 7.1, 0, 0, 0, ['M_FLOW', 'CASH']);

  // Connection between DMT Concession end (dmt-anusorn-sit) and DOH Extension start (doh-dmt-ext-anusorn)
  addE('transfer-dmt-doh-ext', 'dmt-anusorn-sit', 'doh-dmt-ext-anusorn', 'ทางเชื่อมต่อทางยกระดับอุตราภิมุข (สัมปทาน DMT ↔ ส่วนต่อขยาย DOH)', 0.5, 0, 0, 0);
  addE('transfer-doh-dmt-ext', 'doh-dmt-ext-anusorn', 'dmt-anusorn-sit', 'ทางเชื่อมต่อทางยกระดับอุตราภิมุข (ส่วนต่อขยาย DOH ↔ สัมปทาน DMT)', 0.5, 0, 0, 0);

  // 8.5 Motorway M6 Sequential Corridor (Free Trial 0 THB)
  const m6Ordered = [
    'doh-m6-bang-pa-in',
    'doh-m6-wang-noi',
    'doh-m6-hin-kong',
    ...
    'doh-m6-pak-chong',
    'doh-m6-sikhio',
    'doh-m6-kham-thale-so',
  ];
  addSequentialChain(
    m6Ordered,
    'ทางหลวงพิเศษหมายเลข 6 (บางปะอิน-นครราชสีมา)',
    () => [0, 0, 0],
    ['M_FLOW', 'M_PASS', 'EASY_PASS', 'CASH']
  );

  // Bang Pa-in Interchange Transfer Ramps for M6 (Connecting M6 ↔ Udon Ratthaya ↔ M9)
  addE('transfer-m6-udon', 'doh-m6-bang-pa-in', 'bem-bang-pa-in', 'ทางเชื่อมต่างระดับบางปะอิน (มอเตอร์เวย์ M6 ↔ อุดรรัถยา)', 1.5, 0, 0, 0);
  addE('transfer-udon-m6', 'bem-bang-pa-in', 'doh-m6-bang-pa-in', 'ทางเชื่อมต่างระดับบางปะอิน (อุดรรัถยา ↔ มอเตอร์เวย์ M6)', 1.5, 0, 0, 0);
  addE('transfer-m6-m9', 'doh-m6-bang-pa-in', 'doh-m9-thanyaburi-1', 'ทางเชื่อมต่างระดับบางปะอิน (มอเตอร์เวย์ M6 ↔ M9)', 2.0, 0, 0, 0);
  addE('transfer-m9-m6', 'doh-m9-thanyaburi-1', 'doh-m6-bang-pa-in', 'ทางเชื่อมต่างระดับบางปะอิน (มอเตอร์เวย์ M9 ↔ M6)', 2.0, 0, 0, 0);
...
export const PRESET_ROUTES: PresetRoute[] = [
  ...
  {
    id: 'm6-bangpain-to-korat',
    title_th: '🛣️ มอเตอร์เวย์ M6: ด่านบางปะอิน ➔ ด่านขามทะเลสอ / โคราช (ทดลองวิ่งฟรี)',
    title_en: 'Motorway M6: Bang Pa-in ➔ Kham Thale So / Korat (Free Trial)',
    description_th: 'ทางหลวงพิเศษหมายเลข 6 (บางปะอิน-ปากช่อง-นครราชสีมา 196 กม. เปิดทดลองวิ่งฟรี)',
    description_en: 'Motorway M6 (Bang Pa-in - Pak Chong - Nakhon Ratchasima 196 km Free Trial)',
    origin_id: 'doh-m6-bang-pa-in',
    destination_id: 'doh-m6-kham-thale-so',
    icon: 'route',
    badge: 'M6 โคราช (ฟรี 0 บาท)',
  },
  {
